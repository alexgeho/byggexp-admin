...
4. **Anmäl till IMY inom 72 timmar** från kännedom, om incidenten sannolikt innebär en risk för
   registrerades rättigheter (imy.se, e-tjänst). Kan lämnas i etapper.
5. **Informera de registrerade** utan onödigt dröjsmål om hög risk (t.ex. exponerade personnummer/GPS).
6. **Som biträde:** om incidenten rör en kunds data → underrätta kunden (personuppgiftsansvarig)
   utan onödigt dröjsmål så att de kan anmäla.
7. **Åtgärda & dokumentera** – rotorsak, vidtagna åtgärder, lärdomar. För in i incidentloggen nedan.

## Incidentlogg (fylls i vid händelse)
| Datum | Beskrivning | Berörda uppgifter/antal | Riskbedömning | Anmäld IMY (datum) | Registrerade informerade | Åtgärd |
|-------|-------------|-------------------------|---------------|--------------------|--------------------------|--------|
| | | | | | | |
