...
- [ ] Bankimport: заголовки колонок брать из самого Excel (напр. «Datum», а не «Förfallodatum»); если названия нет — оставлять пустым, не выдумывать
- [ ] Bankimport: при выделении строк — нижний прикреплённый бар с опциями (как в Смены/Arbetspass, тёмный, всегда снизу при прокрутке), а не липкая панель сверху
