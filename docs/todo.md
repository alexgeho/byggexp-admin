...
### Сессия 2026-09-23 — кнопки модалок наверх
...
- [ ] Хвост: 5 модалок на голом antd `Modal` с footer-массивом (AssignmentEdit, BulkScan, BulkScanInvoice, BulkPlanning, UserBulkImport) — кнопки пока внизу; перевести на AdminModal
