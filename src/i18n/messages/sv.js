...
export const sv = {
  ...
  'Import bank file': 'Importera bankfil',
  'Match the columns from your bank file, then import the rows.': 'Matcha kolumnerna från din bankfil och importera sedan raderna.',
  'One amount column': 'En beloppskolumn',
  'Separate in/out columns': 'Separata in/ut-kolumner',
  'Money in': 'Insättning',
  'Money out': 'Uttag',
  'Preview': 'Förhandsvisning',
  'Import': 'Importera',
  'None': 'Ingen',
  'Admin type': 'Administratörstyp',
  'Full access (incl. finances)': 'Full åtkomst (inkl. ekonomi)',
  'Limited (projects only)': 'Begränsad (endast projekt)',
  'Full lets them handle finances too; Limited keeps them to projects.': 'Full låter dem även sköta ekonomin; Begränsad håller dem till projekt.',
  ...
  'Simple': 'Enkel',
  'Type the amount': 'Skriv beloppet',
  'Amount → VAT → excl.': 'Belopp → moms → exkl.',
  'Qty × price': 'Antal × pris',
  'Multiply qty by price': 'Multiplicera antal med pris',
  ...
  'You have {n} users – {plan} allows max {max}. Choose Komplett.': 'Ni har {n} användare – {plan} tillåter max {max}. Välj Komplett.',
  ...
  'Contact us for a special offer.': 'Kontakta oss för ett specialerbjudande.',
  'Max {n} users': 'Max {n} användare',
  'More than {n} users?': 'Fler än {n} användare?',
  'Not available yet': 'Inte tillgängligt ännu',
  'Office roles always count; workers only if they clocked in during the last 30 days.': 'Kontorsroller räknas alltid; arbetare bara om de stämplat in de senaste 30 dagarna.',
  'Recommended': 'Rekommenderas',
  'With your {n} users': 'Med era {n} användare',
  'incl. {n} users': 'inkl. {n} användare',
  'per extra user': 'per extra användare',
  'Offers, invoices and invoice reminders': 'Offerter, fakturor och betalningspåminnelser',
  'Payroll, payslips and AGI': 'Lön, lönespecifikation och AGI',
  'Project economy: budget, estimate and profitability': 'Projektekonomi: budget, kalkyl och lönsamhet',
  'Scan receipts and invoices, booked to the project': 'Skanna kvitton och fakturor, bokförda på projektet',
  'Supplier invoices and expenses': 'Leverantörsfakturor och utlägg',
  'Personal finance (coming soon)': 'Personlig ekonomi (kommer snart)',
  'Projects, tasks and photos': 'Projekt, uppgifter och foton',
  'GPS clock-in': 'GPS-instämpling',
  'Diary and self-inspections': 'Dagbok och egenkontroller',
  'Planning and staffing': 'Planering och bemanning',
  'Absence': 'Frånvaro',
  'Tools with QR codes': 'Verktyg med QR-kod',
  'Everything in Projekt': 'Allt i Projekt',
  'Everything in Faktura': 'Allt i Faktura',
  'SIE4 export to Fortnox, Visma and BL': 'SIE4-export till Fortnox, Visma och BL',
  'Supplier invoices via e-mail': 'Leverantörsfakturor via e-post',
  'Custom integrations for an extra fee': 'Egna integrationer mot tillägg',
  ...
  'Welcome to ByggExp': 'Välkommen till ByggExp',
  'Set up your company': 'Konfigurera ditt företag',
  'This invitation link is invalid.': 'Den här inbjudningslänken är ogiltig.',
  'This invitation is invalid or has expired.': 'Inbjudan är ogiltig eller har gått ut.',
  'Account created — welcome!': 'Kontot är skapat — välkommen!',
  'Could not accept the invitation': 'Kunde inte acceptera inbjudan',
  Invitation: 'Inbjudan',
  'Link not valid': 'Länken är ogiltig',
  ...
  'Repeat the password': 'Upprepa lösenordet',
  'Create account & sign in': 'Skapa konto och logga in',
  ...
  "Financial planning": "Ekonomiplanering",
  "Scan invoices": "Skanna fakturor",
  "Bank balance": "Kontosaldo",
  "To pay": "Att betala",
  "To receive": "Att få in",
  "Projected balance": "Prognostiserat saldo",
  "Overdue to pay": "Förfallet att betala",
  "Overdue to collect": "Förfallet att få in",
  "d": "d",
  "d overdue": "d försenad",
  "today": "idag",
  "Remind me": "Påminn mig",
  "days before a payment is due": "dagar innan en betalning förfaller",
  "Upcoming payments appear in the bell this many days before their due date.": "Kommande betalningar visas i klockan så här många dagar före förfallodatum.",
  "Drop invoices from your desktop — pick a project, they are scanned and added": "Släpp fakturor från skrivbordet — välj projekt, de skannas och läggs till",
  "Upcoming payments": "Kommande betalningar",
  "Upcoming receipts": "Kommande inbetalningar",
  "Nothing to collect": "Inget att få in",
  "OCR": "OCR",
  "Customer": "Kund",
  "Invoice to pay": "Faktura att betala",
  "Invoice to collect": "Faktura att få in",
  "days overdue": "dagar försenad",
  "Due today": "Förfaller idag",
  "days left": "dagar kvar",
  "OCR reference": "OCR-referens",
  "OCR reference copied": "OCR-referens kopierad",
  "Bankgiro copied": "Bankgiro kopierat",
  "Plusgiro copied": "Plusgiro kopierat",
  "Bankgiro": "Bankgiro",
  "Plusgiro": "Plusgiro",
  "Could not copy": "Kunde inte kopiera",
  "Copy": "Kopiera",
  "Open document": "Öppna dokument",
  "Open in Invoices": "Öppna i Fakturor",
  "Date": "Datum",
  ...
  "**bold**, *italic*, [link text](https://…), empty line = new paragraph": "**fet**, *kursiv*, [länktext](https://…), tom rad = nytt stycke",
  "About us": "Om oss",
  "Add block": "Lägg till block",
  "Add block here": "Lägg till block här",
  "Add link": "Lägg till länk",
  "Alt text (shown if images are blocked)": "Alt-text (visas om bilder blockeras)",
  "Best: JPG or PNG, 1200px wide, under 300 KB.": "Bäst: JPG eller PNG, 1200 px bred, under 300 kB.",
  "Build a mailing from ready-made blocks — images, text, buttons and product cards.": "Bygg ett utskick av färdiga block – bilder, text, knappar och produktkort.",
  "Build mailings from ready-made blocks": "Bygg utskick av färdiga block",
  "Button": "Knapp",
  "Button text": "Knapptext",
  "Buttons & links": "Knappar & länkar",
  "Campaign name for Google Analytics (utm_campaign)": "Kampanjnamn för Google Analytics (utm_campaign)",
  "Colours": "Färger",
  "Company address and org. no. (required in marketing emails)": "Företagsadress och org.nr (krävs i marknadsföringsmejl)",
  "Content": "Innehåll",
  "Copy HTML": "Kopiera HTML",
  "Could not create newsletter": "Kunde inte skapa nyhetsbrevet",
  "Could not delete newsletter": "Kunde inte ta bort nyhetsbrevet",
  "Could not duplicate newsletter": "Kunde inte kopiera nyhetsbrevet",
  "Could not load newsletters": "Kunde inte hämta nyhetsbrev",
  "Could not save": "Kunde inte spara",
  "Could not upload image": "Kunde inte ladda upp bilden",
  "Create your first newsletter": "Skapa ditt första nyhetsbrev",
  "Delete this newsletter?": "Ta bort nyhetsbrevet?",
  "Design & footer": "Design & sidfot",
  "Desktop": "Dator",
  "Divider": "Avdelare",
  ...
  "Filled": "Ifylld",
  "Footer": "Sidfot",
  "Full width (600px)": "Full bredd (600 px)",
  "Grey text": "Grå text",
  "HTML copied": "HTML kopierad",
  "Header": "Sidhuvud",
  "Heading": "Rubrik",
  "Height (px)": "Höjd (px)",
  "Image": "Bild",
  ...
  "Link text under the image": "Länktext under bilden",
  "Logo": "Logotyp",
  "Logo link": "Logotypens länk",
  "Logo width (px)": "Logotypens bredd (px)",
  "Medium": "Mellan",
  "Menu links": "Menylänkar",
  "New newsletter": "Nytt nyhetsbrev",
  "Newsletter not found": "Nyhetsbrevet hittades inte",
  "Newsletters": "Nyhetsbrev",
  "No newsletters yet": "Inga nyhetsbrev än",
  "Outline": "Kontur",
  "Preview text (shown after the subject in the inbox)": "Förhandstext (visas efter ämnesraden i inkorgen)",
  "Preview — exactly what recipients get": "Förhandsvisning – exakt det mottagarna får",
  ...
  "Text & headings": "Text & rubriker",
  "The subject gets a [TEST] prefix. Check it in Gmail and Outlook before sending to customers.": "Ämnesraden får prefixet [TEST]. Kontrollera i Gmail och Outlook innan du skickar till kunder.",
  "Unsaved changes": "Osparade ändringar",

  // Email marketing / mailer (superadmin)
  "A campaign sends one of your newsletter designs to a subscriber list.": "En kampanj skickar en av dina nyhetsbrevsdesigner till en prenumerationslista.",
  "Activity": "Aktivitet",
  "Added": "Tillagda",
  "All events": "Alla händelser",
  "All lists": "Alla listor",
  "All statuses": "Alla statusar",
  "Already in the list (updated)": "Fanns redan i listan (uppdaterade)",
  "Bounced": "Studs",
  "Campaign": "Kampanj",
  "Campaign not found": "Kampanjen hittades inte",
  "Campaign scheduled": "Kampanjen är schemalagd",
  "Campaigns": "Kampanjer",
  "Cancelled": "Avbruten",
  "Check addresses": "Kontrollera adresser",
  "Check failed": "Kontrollen misslyckades",
  "Checked": "Kontrollerad",
  "Checked {x} addresses: {v} OK, {i} not deliverable": "Kontrollerade {x} adresser: {v} OK, {i} går inte att leverera till",
  "Checking…": "Kontrollerar…",
  "Choose a design": "Välj design",
  "Choose a list": "Välj lista",
  "Choose which column contains the email address": "Välj vilken kolumn som innehåller e-postadressen",
  "Clicked": "Klickade",
  "Connection OK — the SMTP server accepted the login": "Anslutningen fungerar – SMTP-servern godkände inloggningen",
  "Connection failed": "Anslutningen misslyckades",
  "Could not create campaign": "Kunde inte skapa kampanjen",
  "Could not delete": "Kunde inte ta bort",
  "Could not load campaigns": "Kunde inte hämta kampanjer",
  "Could not load lists": "Kunde inte hämta listor",
  "Could not load settings": "Kunde inte hämta inställningar",
  "Could not load subscribers": "Kunde inte hämta prenumeranter",
  "Create a list and import addresses from a CSV or Excel file.": "Skapa en lista och importera adresser från en CSV- eller Excel-fil.",
  "Create your first campaign": "Skapa din första kampanj",
  "Create your first list": "Skapa din första lista",
  "Delete selected": "Ta bort markerade",
  "Delete the campaign? Its statistics are deleted too.": "Ta bort kampanjen? Statistiken tas också bort.",
  "Delete the list and all its subscribers?": "Ta bort listan och alla dess prenumeranter?",
  "Delete the subscriber?": "Ta bort prenumeranten?",
  "Delete {x} subscribers?": "Ta bort {x} prenumeranter?",
  "Deliverability checklist": "Checklista för leverans",
  "Designs": "Designer",
  "Drop a CSV or Excel file here, or click to choose": "Släpp en CSV- eller Excel-fil här, eller klicka för att välja",
  "Duplicates in the file": "Dubbletter i filen",
  "Edit design": "Redigera design",
  "Email address": "E-postadress",
  "Email marketing": "Nyhetsbrev",
  "Enter an SMTP account before sending campaigns": "Ange ett SMTP-konto innan du skickar kampanjer",
  "Event": "Händelse",
  "Every mail has a one-click unsubscribe link and header — added automatically.": "Varje mejl har en avregistreringslänk och one-click-header – läggs till automatiskt.",
  "Everyone on your mailing lists": "Alla på dina utskickslistor",
  "File (CSV / Excel)": "Fil (CSV / Excel)",
  "Import and manage recipient lists": "Importera och hantera mottagarlistor",
  "Import failed": "Importen misslyckades",
  "Import finished": "Importen är klar",
  "Import more": "Importera fler",
  "Import subscribers": "Importera prenumeranter",
  "Import {x} rows": "Importera {x} rader",
  "Invalid addresses (skipped)": "Ogiltiga adresser (hoppades över)",
  "It goes out gradually at the rate set under Settings.": "Den skickas ut successivt i den takt som anges under Inställningar.",
  "Live log": "Realtidslogg",
  "Mailer settings": "Inställningar",
  "Max emails per hour": "Max antal mejl per timme",
  "Name (only shown internally)": "Namn (visas bara internt)",
  "New campaign": "Ny kampanj",
  "New list": "Ny lista",
  "New subscriber": "Ny prenumerant",
  "New subscriber list": "Ny prenumerationslista",
  "Newsletter (design)": "Nyhetsbrev (design)",
  "No": "Nej",
  "No campaigns yet": "Inga kampanjer än",
  "No designs yet — create one under Designs": "Inga designer än – skapa en under Designer",
  "No events yet. Opens, clicks, unsubscribes and bounces show up here.": "Inga händelser än. Öppningar, klick, avregistreringar och studsar visas här.",
  "No lists yet — create one under Lists": "Inga listor än – skapa en under Prenumerationslistor",
  "No subscriber lists yet": "Inga prenumerationslistor än",
  "Not checked": "Ej kontrollerad",
  "One row per recipient. Columns: email (required), name, company, city.": "En rad per mottagare. Kolumner: e-post (krävs), namn, företag, ort.",
  "Opened": "Öppnade",
  "Paste addresses": "Klistra in adresser",
  "Pause": "Pausa",
  "Port": "Port",
  "Port 587 = STARTTLS (most common), 465 = SSL.": "Port 587 = STARTTLS (vanligast), 465 = SSL.",
  "Previously unsubscribed/bounced (will not be mailed)": "Tidigare avregistrerade/studsade (får inga mejl)",
  "Recipients": "Mottagare",
  "Recipients are picked when sending starts, so addresses imported before then are included.": "Mottagarna hämtas när utskicket startar, så adresser som importeras innan dess kommer med.",
  "Rename": "Byt namn",
  "Rename list": "Byt namn på listan",
  "Reply-to (optional)": "Svarsadress (valfritt)",
  "SMTP account, sender and sending speed": "SMTP-konto, avsändare och utskickstakt",
  "SMTP is configured": "SMTP är inställt",
  "SPF, DKIM and DMARC records for the sender domain (set in the domain's DNS).": "SPF-, DKIM- och DMARC-poster för avsändardomänen (sätts i domänens DNS).",
  "Save and test connection": "Spara och testa anslutningen",
  "Schedule campaign": "Schemalägg kampanj",
  "Scheduled for {x}": "Schemalagd till {x}",
  "Search email, name, company…": "Sök e-post, namn, företag…",
  "Search email…": "Sök e-post…",
  "Send a design to a subscriber list": "Skicka en design till en prenumerationslista",
  "Send now": "Skicka nu",
  "Send the campaign now?": "Skicka kampanjen nu?",
  "Send to business addresses (B2B); private persons need prior consent.": "Skicka till företagsadresser (B2B); privatpersoner kräver samtycke i förväg.",
  "Sender": "Avsändare",
  "Sender address": "Avsändaradress",
  "Sender name": "Avsändarnamn",
  "Sending": "Skickar",
  "Sending resumed": "Utskicket återupptogs",
  "Sending started": "Utskicket har startat",
  "Sends, opens, clicks, unsubscribes and bounces as they happen": "Utskick, öppningar, klick, avregistreringar och studsar i realtid",
  "Sent through the mailer SMTP with [TEST] in the subject. Name and company tags are filled with test values.": "Skickas via utskickets SMTP med [TEST] i ämnesraden. Namn- och företagstaggar fylls med testvärden.",
  "Server": "Server",
  "Setting Active again lifts the block — only do it if the person asked to get mail again.": "Aktiv igen tar bort spärren – gör det bara om personen bett om att få mejl igen.",
  "Show subscribers": "Visa prenumeranter",
  "Showing {a}–{b} of {c}": "Visar {a}–{b} av {c}",
  "Something went wrong": "Något gick fel",
  "Spam complaint": "Spamanmälan",
  "Start low (50–100/h) on a new domain and raise it gradually. Also check your mail host's own sending limit.": "Börja lågt (50–100/h) på en ny domän och höj successivt. Kontrollera också e-postleverantörens egen sändningsgräns.",
  "Stop": "Stoppa",
  "Stop the campaign for good? Remaining recipients will not get it.": "Stoppa kampanjen helt? Återstående mottagare får den inte.",
  "Stored encrypted and never shown again.": "Sparas krypterat och visas aldrig igen.",
  "Subscriber list": "Prenumerationslista",
  "Subscriber lists": "Prenumerationslistor",
  "Subscribers": "Prenumeranter",
  "The footer of each design has the company address and org. no.": "Sidfoten i varje design har företagets adress och org.nr.",
  "Tip: {{namn}} and {{företag}} are replaced with the recipient's name and company.": "Tips: {{namn}} och {{företag}} byts mot mottagarens namn och företag.",
  "Track link clicks": "Spåra klick på länkar",
  "Track opens (invisible image)": "Spåra öppningar (osynlig bild)",
  "Unsubscribed": "Avregistrerad",
  "Unsubscribes and hard bounces are never mailed again — handled automatically.": "Avregistrerade och hårda studsar får aldrig mejl igen – sköts automatiskt.",
  "Use a separate sender address for newsletters (e.g. a mailbox on a separate domain), not the one used for invoices and login codes — then a spam complaint on a campaign cannot affect the product's own mail.": "Använd en separat avsändaradress för nyhetsbrev (t.ex. en brevlåda på en egen domän), inte den som används för fakturor och inloggningskoder – då kan en spamanmälan på en kampanj inte påverka produktens egna mejl.",
  "Username": "Användarnamn",
  "Where replies go. The sender address should belong to the SMTP account above.": "Dit svar skickas. Avsändaradressen ska tillhöra SMTP-kontot ovan.",
  "Which column is what?": "Vilken kolumn är vad?",
  "Yes": "Ja",
  "{x} rows": "{x} rader",
