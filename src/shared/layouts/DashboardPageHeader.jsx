...
const PAGE_SUBTITLES = {
  admin: {
    ...
    dagbok: 'Site diary â weather, crew and work performed per day',
    kma: 'Quality, environment and work-environment self-inspections',
    leave: 'Absence requests — vacation, sick leave and VAB',
    offers: 'Manage and track all offers',
    invoices: 'Manage and track all invoices',
    payroll: 'Turn worked hours into salary runs',
    'supplier-invoices': 'Register and approve incoming supplier invoices',
    'expenses': 'Review and reimburse receipts from the field',
